...
$Cov(\hat{\boldsymbol\beta})=Cov((X^T X+\lambda\mathbf{I})^{-1}X^T Y)=(X^TX+\lambda\mathbf{I})^{-1}X^T Cov(Y)((X^TX+\lambda\mathbf{I})^{-1}X^T)^T=(X^TX+\lambda\mathbf{I})^{-1}X^T \sigma^2  I ((X^TX+\lambda\mathbf{I})^{-1}X^T)^T\\$
...
Additionally:
$\operatorname{Var}(\boldsymbol{x}_0^T\hat{\boldsymbol{\beta}}) = \boldsymbol{x}_0^T \operatorname{Var}(\hat{\boldsymbol{\beta}}) \boldsymbol{x}_0=\boldsymbol{x}_0^T (X^TX+\lambda\mathbf{I})^{-1}X^T \sigma^2  I ((X^TX+\lambda\mathbf{I})^{-1}X^T)^T \boldsymbol{x}_0$
